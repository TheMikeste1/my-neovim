-- TODO: Maybe switch to https://github.com/folke/persistence.nvim
return {
  ...
  config = function()
    ...
    require("session_manager").setup({
      sessions_dir = vim.fs.joinpath(vim.fn.stdpath("data"), "sessions"), -- The directory where the session files will be saved.
